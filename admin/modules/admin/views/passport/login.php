...
$copyright = $copyright ? $copyright : '©2019 <a href="http://ifhu.cn" target="_blank">富方信息科技</a>';
        ...
        <div class="card-body">
            ...
            <div class="form-inline mb-3">
                <div class="w-100">
                    ...
                    <img class="refresh-login-captcha"
                         data-refresh="<?= Yii::$app->urlManager->createUrl(['admin/passport/login-captcha', 'refresh' => 1,]) ?>"
                         src="<?= Yii::$app->urlManager->createUrl(['admin/passport/login-captcha',]) ?>"
...
<script>
    ...
    $(document).ready(function(){
        $('.refresh-login-captcha').click();
        console.log('test');
    });

    $(document).on('click', '.refresh-login-captcha', function() {
        var img = $(this);
