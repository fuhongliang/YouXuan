        ...
        if (!empty($this->select_key)) {
            ...
            $price_list = [
                ...
                [
                    ...
                    'price' => 50,
                    'origin' => 100,
                    'vip_time' => 3600*24*31*12,
                ],

            ];
            $after_level = Level::findone([
                'is_delete' => 0,
                'store_id' =>$this->store_id
            ])->level;
            foreach ($price_list as $k=>$v) {
                if ($this->select_key == $v['key']) {
                    $pay_price = $v['price'];
                    $vip_time = $v['vip_time'];
                }
            }
