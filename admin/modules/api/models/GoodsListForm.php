...
class GoodsListForm extends ApiModel
{
    ...
    public function search($limit = 12)
    {
        if (!$this->validate())
        ...
        $list = $query
            ...
            ->select('g.id,g.name,g.price,g.original_price,g.cover_pic pic_url,gn.num,g.virtual_sales,g.unit,g.is_negotiable,g.attr')
