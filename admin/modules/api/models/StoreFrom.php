...
class StoreFrom extends ApiModel
{
    ...
    public function search()
    {
        ...
        $images = [
            'vip' =>[
                'item' =>[
                    'item_1_bg' => $wxappUrl.'/vip/item-1-bg.png',
                    'item_2_bg' => $wxappUrl.'/vip/item-2-bg.png',
                    'item_3_bg' => $wxappUrl.'/vip/item-3-bg.png',
                    'item_4_bg' => $wxappUrl.'/vip/item-4-bg.png',
                ],
                'quanyi_1' => $wxappUrl.'/vip/quanyi-1.png',
                'quanyi_2' => $wxappUrl.'/vip/quanyi-2.png',
                'quanyi_3' => $wxappUrl.'/vip/quanyi-3.png',
                'quanyi_4' => $wxappUrl.'/vip/quanyi-4.png',
            ],
            'userCenter' => [
                'vip_quanyi_1' => $wxappUrl.'/user/vip-quanyi-1.png',
                'vip_quanyi_2' => $wxappUrl.'/user/vip-quanyi-2.png',
                'vip_quanyi_3' => $wxappUrl.'/user/vip-quanyi-3.png',
                'vip_quanyi_4' => $wxappUrl.'/user/vip-quanyi-4.png',
                'vip_quanyi_bg' => $wxappUrl.'/user/vip-quanyi-bg.png',
            ],
            'integralMall' => [ // 模块名称
                'register' => [ // 小程序页面
                    'register_bg' => [ // 图片名称
