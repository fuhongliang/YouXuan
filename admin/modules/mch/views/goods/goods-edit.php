...
<div class="panel mb-3" id="page">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#tab_basic" role="tab">基础信息</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#images" role="tab">图片视频</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#stock" role="tab">库存规格</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#share" role="tab">营销分销</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#desc" role="tab">图文详情</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <div class="video-picker"
                            ...
                            <div>
                                <span class="text-danger fs-sm">支持格式mp4;支持编码H.264;视频大小不能超过<?= \app\models\UploadForm::getMaxUploadSize() ?>MB</span></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="share" role="tabpanel">
                <!-- 营销 -->
                <div <?= in_array(get_plugin_type(), [5]) ? 'hidden' : '' ?>>
                    <div class="form-group row">
                        <div class="col-3 text-right">
                        ...
                        <div class="col-9">
                            <div class="card short-row p-2 mb-2"
                                ...
                                <div flex="dir:left box:last">
                                    ...
                                    <div style="width: 100%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;word-break: break-all">
                                        {{item.name}}
                                    </div>
                ...
                <!-- 快速购买开始  -->
                <div <?= in_array(get_plugin_type(), [2,5]) ? 'hidden' : '' ?>>
                    <div class="form-group row">
                        <div class="col-3 text-right">
            ...
            <div class="tab-pane" id="desc" role="tabpanel">
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <textarea class="short-row" id="editor" name="model[detail]"><?= $goods['detail'] ?></textarea>
                    </div>
                </div>
            </div>
        </div>
