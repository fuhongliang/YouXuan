...
<ul class="nav nav-tabs-custom">
    <li class="<?= $status == -1 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => -1])) ?>">全部</a></li>
    <li class="<?= $status == 0 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 0])) ?>">未付款<?= $store_data['status_count']['status_0'] ? '(' . $store_data['status_count']['status_0'] . ')' : null ?></a></li>
    <li class="<?= $status == 1 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 1])) ?>">待发货<?= $store_data['status_count']['status_1'] ? '(' . $store_data['status_count']['status_1'] . ')' : null ?></a></li>
    <li class="<?= $status == 2 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 2])) ?>">待收货<?= $store_data['status_count']['status_2'] ? '(' . $store_data['status_count']['status_2'] . ')' : null ?></a></li>
    <li class="<?= $status == 3 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 3])) ?>">已完成<?= $store_data['status_count']['status_3'] ? '(' . $store_data['status_count']['status_3'] . ')' : null ?></a></li>
    <li class="<?= $status == 6 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 6])) ?>">待处理<?= $store_data['status_count']['status_6'] ? '(' . $store_data['status_count']['status_6'] . ')' : null ?></a></li>
    <li class="<?= $status == 5 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 5])) ?>">已取消<?= $store_data['status_count']['status_5'] ? '(' . $store_data['status_count']['status_5'] . ')' : null ?></a></li>
    <li class="<?= $status == 7 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 7])) ?>">异常订单</a></li>
    <li class="<?= $is_recycle == 1 ? 'active' : null ?>"><a href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['is_recycle' => 1])) ?>">回收站</a></li>
</ul>
<?php $this->endBlock(); ?>
        ...
        <ul class="nav nav-tabs status">
            <li class="nav-item">
                <a class="status-item nav-link <?= $status == -1 ? 'active' : null ?>"
                   href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']])) ?>">全部</a>
            </li>
            <li class="nav-item">
                <a class="status-item nav-link <?= $status == 0 ? 'active' : null ?>"
                   href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 0])) ?>">未付款<?= $store_data['status_count']['status_0'] ? '(' . $store_data['status_count']['status_0'] . ')' : null ?></a>

            </li>
            <li class="nav-item">
                <a class="status-item nav-link <?= $status == 1 ? 'active' : null ?>"
                   href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 1])) ?>">待发货<?= $store_data['status_count']['status_1'] ? '(' . $store_data['status_count']['status_1'] . ')' : null ?></a>
            </li>
            <li class="nav-item">
                <a class="status-item  nav-link <?= $status == 2 ? 'active' : null ?>"
                   href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 2])) ?>">待收货<?= $store_data['status_count']['status_2'] ? '(' . $store_data['status_count']['status_2'] . ')' : null ?></a>
            </li>
            <li class="nav-item">
                <a class="status-item  nav-link <?= $status == 3 ? 'active' : null ?>"
                   href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 3])) ?>">已完成<?= $store_data['status_count']['status_3'] ? '(' . $store_data['status_count']['status_3'] . ')' : null ?></a>
            </li>
            <li class="nav-item">
                <a class="status-item  nav-link <?= $status == 6 ? 'active' : null ?>"
                   href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 6])) ?>">待处理<?= $store_data['status_count']['status_6'] ? '(' . $store_data['status_count']['status_6'] . ')' : null ?></a>
            </li>
            <li class="nav-item">
                <a class="status-item  nav-link <?= $status == 5 ? 'active' : null ?>"
                   href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['status' => 5])) ?>">已取消<?= $store_data['status_count']['status_5'] ? '(' . $store_data['status_count']['status_5'] . ')' : null ?></a>
            </li>
            <li class="nav-item">
                <a class="status-item  nav-link <?= $is_recycle == 1 ? 'active' : null ?>"
                   href="<?= $urlManager->createUrl(array_merge(['mch/order/index'],[$_GET['r']], $condition, ['is_recycle' => 1])) ?>">回收站</a>
            </li>
        </ul>
    </div>
