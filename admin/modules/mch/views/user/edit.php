        ...
        <div class="">
            <form method="post" class="form auto-form" autocomplete="off"
                ...
                <div class="form-body">
                        ...
                        <div class="col-2">
                            <select class="form-control" name="level">
                                ...
                                <?php foreach ($level as $value) : ?>
                                    <option value="<?= $value->level ?>" <?= ($value->level == $user->level) ? "selected" : "" ?>><?= $value->name ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="form-group-label col-2 text-right">
                            <label class="col-form-label">VIP到期时间</label>
                        </div>
                        <div class="col-5">
                            <div style="width: 250px;" flex="dir:left box:last">
                                <input class="form-control" id="date_start" name="vip_end_time" autocomplete="off"
                                       value="<?= date('Y-m-d H:i:s', $user->vip_end_time); ?>">
                                <span class="input-group-btn">
                                    <a class="btn btn-secondary" id="show_date_start" href="javascript:">
                                        <span class="iconfont iconrili1"></span>
                                    </a>
                                </span>
                            </div>
                        </div>
